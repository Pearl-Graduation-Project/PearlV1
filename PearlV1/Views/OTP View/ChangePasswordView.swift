...
struct ChangePasswordView: View {
    ...
    @State private var isPopupVisible = false // Use this state variable
    ...
    var body: some View {
            ...
            MainBTN(
                action: {
                    ...
                    if newPassword == confirmPassword {
                        ...
                        errorMessage = nil
                        isPopupVisible.toggle() // Toggle the visibility of the popup
        ...
        .overlay(
            ZStack {
                if isPopupVisible {
                    PopupView(isPopupPresented: $isPopupVisible)
